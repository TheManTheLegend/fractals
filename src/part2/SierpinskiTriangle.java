...
public class SierpinskiTriangle implements MouseListener, MouseMotionListener{ 
	static int z = 0;
	static SierpinskiTriangle triangle = new SierpinskiTriangle();
...
//		drawTriangle(tl, tr, lr, new Color(2*n*n,n*n*n/4,n*25));
	...
	public void mouseDragged(MouseEvent arg0) {
		// TODO Auto-generated method stub
		black = new Color(arg0.getX(),arg0.getY(), arg0.getY());
		triangle.draw(z);
	}
